    ...
    with trt.Builder(logger) as builder:  # type: Builder
        with builder.create_network(
            ...
            with trt.OnnxParser(
                ...
                print("Building TensorRT Engine using {}".format(config.flags))
...
def load_engine(
    runtime: Runtime, engine_file_path: str, logger:Logger, profile_index: int = 0, 
